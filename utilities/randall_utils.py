# -*- coding: utf-8 -*-
'''
This utitlies file is part work part adaptation. There are very specific call outs and variables that correspond to 
f-string variables. 
'''
...
def plot_confusion_matrix(cm, classes,  normalize=False, title='Confusion matrix - RTaylor', cmap=plt.cm.Blues):
    import numpy as np
    import itertools
